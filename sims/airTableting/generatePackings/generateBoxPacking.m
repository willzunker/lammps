...
N_goal = 700;  % goal for number of particles to insert
...
filename = '../square_tablet/spheres_700.data';
atom_types = 3; % define total number of atom types in your simulation
id = (1:1:N_goal)';
...
filename = '../square_tablet/spheres_heavy_700.data';
...
% define properties needed for writing data file 
filename = '../square_tablet/sphere_punch_tight.data';
N_punchMax = length(sphereRadii);
id = ((N_goal+1):1:(N_goal+N_punchMax))';
N_punch = length(id);
atom_type = 2*ones(N_punch,1);
