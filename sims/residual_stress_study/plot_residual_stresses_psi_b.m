function plot_residual_stresses_psi_b(results_file,Y,psi_b)
...
figure()
plot(psi_b', residual_stress./Y, marker{1},'MarkerSize', markersize, 'MarkerFaceColor', markercolor{1} , 'MarkerEdgeColor', markeredgecolor, 'LineWidth', linewidth)
...
xlabel('$\psi_b$','Interpreter','latex','FontSize', labelFontsize);
