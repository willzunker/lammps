function generateCylinderPacking(R_mean,R_std)

%% generate packing residual stress study
...
N_goal = 800;  % goal for number of particles to insert
%R_mean = 0.33e-3;   % average sphere radius
%R_std = R_mean*0.0;   % standard deviation of sphere radius
