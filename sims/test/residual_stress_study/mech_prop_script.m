function mech_prop_script(parameters,k,i,j,results_file,E,gammap)

IDi = num2str(i);
IDj = num2str(j);
IDk = num2str(k);
filename = strcat(results_file,'/in.mech_prop_',IDk,'_',IDi,IDj);
dump_name = strcat('mech_prop_',IDk,'_',IDi,IDj,'.dump');
force_disp_name = strcat('mech_prop_',IDk,'_',IDi,IDj,'_force_disp.csv');
avg_stresses_name = strcat('mech_prop_',IDk,'_',IDi,IDj,'_avg_stresses.csv');
...
disp('LAMMPS input file in.E_Y has been created.');
