function mu_s_w_script(parameters,i,results_file,mu_s_w)

ID = num2str(i);
filename = strcat(results_file,'/in.mu_s_w_',ID);
dump_name = strcat('mu_s_w_',ID,'.dump');
force_disp_name = strcat('mu_s_w_',ID,'_force_disp.csv');
avg_stresses_name = strcat('mu_s_w_',ID,'_avg_stresses.csv');
