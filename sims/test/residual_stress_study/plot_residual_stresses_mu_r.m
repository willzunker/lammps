function plot_residual_stresses_mu_r(results_file,Y,mu_r)
...
figure()
plot(mu_r', residual_stress./Y, marker{1},'MarkerSize', markersize, 'MarkerFaceColor', markercolor{1} , 'MarkerEdgeColor', markeredgecolor, 'LineWidth', linewidth)
...
xlabel('$\mu_\textrm{roll}$','Interpreter','latex','FontSize', labelFontsize);
