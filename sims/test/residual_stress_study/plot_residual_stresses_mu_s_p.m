function plot_residual_stresses_mu_s_p(results_file,Y,mu_s_p)
...
figure()
plot(mu_s_p', residual_stress./Y, marker{1},'MarkerSize', markersize, 'MarkerFaceColor', markercolor{1} , 'MarkerEdgeColor', markeredgecolor, 'LineWidth', linewidth)
...
xlabel('$\mu_t$','Interpreter','latex','FontSize', labelFontsize);
