function plot_residual_stresses_mu_s_w(results_file,Y,mu_s_w)
...
figure()
plot(mu_s_w', residual_stress./Y, marker{1},'MarkerSize', markersize, 'MarkerFaceColor', markercolor{1} , 'MarkerEdgeColor', markeredgecolor, 'LineWidth', linewidth)
...
xlabel('$\mu_{t,\textrm{wall}}$','Interpreter','latex','FontSize', labelFontsize);
