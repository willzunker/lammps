function psi_b_script(parameters,i,results_file,psi_b)

ID = num2str(i);
filename = strcat(results_file,'/in.psi_b_',ID);
dump_name = strcat('psi_b_',ID,'.dump');
force_disp_name = strcat('psi_b_',ID,'_force_disp.csv');
avg_stresses_name = strcat('psi_b_',ID,'_avg_stresses.csv');
