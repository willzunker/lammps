function strain_script(parameters,i,results_file)

ID = num2str(i);
filename = strcat(results_file,'/in.strain_',ID);
dump_name = strcat('strain_',ID,'.dump');
force_disp_name = strcat('strain_',ID,'_force_disp.csv');
avg_stresses_name = strcat('strain_',ID,'_avg_stresses.csv');
